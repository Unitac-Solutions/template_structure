...
module.exports.createmedical_aid = async (obj , id = 0) => {
    ...
    provider, name, med_aid_option, number, dept_code, main_member, auth_number, next_of_kin_name, next_of_kin_contact, next_of_kin_relationship, created_by
    ) VALUES(?,?,?,?,?,?,?,?,?,?,?)`,
    [obj.provider, obj.name, obj.med_aid_option, obj.number, obj.dept_code, obj.main_member, obj.auth_number, obj.next_of_kin_name, obj.next_of_kin_contact, obj.next_of_kin_relationship,  obj.userInfo.user_id])
    .catch(err => console.log(err))
    return data;
} 
